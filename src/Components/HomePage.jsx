...
const hcbgImage = `https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_1080,h_675/https://digitaldealer.com/wp-content/uploads/2018/06/Screen-Shot-2018-06-07-at-10.13.29-AM.png`;
    ...
    return (
        <div>
            ...
            <div className="homeImage"
                ...
                >
                    <Box padding="250px">
                        <Box width="40%" margin="auto" border="solid red 1px" >
                            <Flex>
                            <Button w="50%" height="50px" colorScheme='teal' variant='outline' bgColor="#fff" color="#10a310" borderRadius="none">
                                Round Trip
                            </Button>
                            <Button w="50%" height="50px" colorScheme='teal' variant='outline' bgColor="#fff" color="#10a310" borderRadius="none">
                                Airport Round Trip
                        ...
                        <Box width="40%" margin="auto" border="solid red 1px" marginTop="10px">
                            <Input
                            bgColor="#ffffff"
                            height="50px"
                        ...
                        <Button w="100%" height="50px" colorScheme='gray' variant='solid' bgColor="#fff" color="gray">
                            Find Cars
                        </Button>
                        </Box>
                    </Box>
